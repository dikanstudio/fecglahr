...
import Column1 from "../assets/reha/Column1.jpg";
import Column2 from "../assets/reha/Column2.jpg";
import Column3 from "../assets/reha/Column3.jpg";
    ...
    <div className="">
      <div className="hidden 2xl:block xl:block lg:block">
        <div className="w-screen h-screen">
          ...
          <div className="2xl:pt-20 xl:pt-16 lg:pt-10">
            ...
            <div className="flex mt-20 mr-10 ml-10 gap-5">
              ...
              <div className="flex-col w-1/2 border-l-2 p-2">
                ...
                <p className="text-lg text-left lg:text-sm xl:text-lg">
                  {" "}
                  ...
                  brauchst, wir sind für dich da. Unsere Tür steht immer offen.
                  Du verdienst Unterstützung und Verständnis auf deinem Weg zur
        ...
        <div className="w-screen p-10 bg-slate-100 border-t-2 border-b-2">
          <div className="grid grid-cols-2 gap-10">
            <img src={BetesdaLogo} className="rounded-md"></img>
            <p className="text-justify 2xl:text-2xl xl:text-lg">
              ...
              oder bei der Vermittlung von Arbeit zu unterstützen, sondern auch
              den Glauben zu stärken und fürsorgliche Begleitung anzubieten. Bei
              Betesda geht es darum, jedem Einzelnen eine zweite Chance zu geben
              und sie auf ihrem Weg zur Rehabilitation zu begleiten. Unsere
              Programme umfassen neben geistlicher und psychischer Unterstützung
              auch die Möglichkeit, Jesus und sein Leben näher kennenzulernen
              durch Bibelanalysen und Reflexionen. Wir glauben fest daran, dass
              ein sinnvolles und erfülltes Leben im Glauben, geprägt von Liebe
              und ohne Kriminalität, möglich ist. Unsere liebevolle Gemeinschaft
              bietet dabei Unterstützung und Begleitung auf diesem Weg der
        ...
        <div className="w-screen h-screen p-10 flex items-center justify-center">
          <div className="">
            <h1 className="text-5xl text-left pb-5 border-b-2">Unsere Werte</h1>
            <p className="text-justify pt-5 text-xl pb-5 border-b-2">
              Eine zentrale Rolle spielt dabei die Bereitstellung von Unterkunft
              und Verpflegung in Form von Wohngemeinschaften, die darauf
              ausgerichtet sind, den Bewohnern eine unterstützende und
              glaubensbasierte Umgebung zu bieten. Hier können die Bewohner von
              regelmäßiger Seelsorge und Arbeitstherapie profitieren, um nicht
              nur ihre psychischen und emotionalen Probleme zu bewältigen,
              sondern auch eine tiefere geistliche Verbindung zu entwickeln. Wir
              glauben fest daran, dass die Integration von Glauben und Therapie
              dazu beiträgt, dass die Menschen eine positive Einstellung
              entwickeln und ihre Herausforderungen mit Hoffnung und Zuversicht
              angehen können.
            </p>
            <div className="grid grid-cols-3 gap-10 pt-5">
              <img src={Column1} className="rounded-md"></img>
              <img src={Column2} className="rounded-md"></img>
              <img src={Column3} className="rounded-md"></img>
            </div>
          </div>
        </div>

        <div className="w-screen h-screen p-10 flex items-center justify-center bg-slate-900">
          <div className="">
            <h1 className="text-5xl text-right text-gray-200 pb-5 border-b-2">Unsere Mission</h1>
            <p className="text-justify pt-5 text-xl pb-5 border-b-2 text-gray-200">
              Ein weiterer bedeutender Aspekt unserer Arbeit liegt in der
              Unterstützung bei der Eingliederung in die Arbeitswelt. Wir setzen
              gezielte Maßnahmen ein, um jeder Person eine
              berufliche Perspektive zu bieten, die auf ihrem persönlichen
              Wachstum und ihrem Glauben aufbaut. Durch die Förderung von
              Freizeitangeboten und kulturellen Aktivitäten streben wir danach,
              das Selbstbewusstsein zu stärken und ein positives soziales Umfeld
              zu schaffen, das von christlichen Werten geprägt ist. Denn wir
              glauben fest daran, dass eine sinnvolle berufliche Tätigkeit nicht
              nur die finanzielle Stabilität fördert, sondern auch dazu beiträgt,
              dass die Menschen ihre Talente entfalten und einen wertvollen
              Beitrag zur Gesellschaft leisten können, während sie gleichzeitig
              ein erfülltes Leben im Glauben führen.
            </p>
            </div>
        </div>
      </div>
      ...
      <div className="2xl:hidden xl:hidden lg:hidden block bg-slate-100">
        <div className="w-screen">
          {/*<img src={BetesdaLogo} className=""></img>*/}
          <h1 className="text-6xl mb-10 text-center pt-24">Rehabilitation</h1>
        ...
        <div className="w-screen">
          <div className="m-5 pt-8">
            <div className="bg-white rounded-md shadow-md flex flex-col justify-evenly">
              <div className="pb-5">
                <img src={BetesdaLogo} className="rounded-tr-md rounded-tl-md"></img>
              </div>
        ...
        <div className="w-screen">
          <div className="m-5 pt-8">
            ...
            <div className="bg-white rounded-md shadow-md flex flex-col justify-evenly mt-8">
            <h1 className="text-5xl text-left p-5 border-b-2">Unsere Werte</h1>
              <p className="text-justify pt-2 p-5">
        ...
        <div className="w-screen">
          <div className="m-5 pt-8">
            <div className="bg-white rounded-md shadow-md flex flex-col justify-evenly">
              <div className="pb-5">
                <img src={Wood} className="rounded-tr-md rounded-tl-md"></img>
              </div>
              <div className="flex justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-justify pt-2 p-5">
                ...
                setzen gezielte Maßnahmen ein, um jeder Person
